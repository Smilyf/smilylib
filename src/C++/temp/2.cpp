...
int main()
{
    ...
    HANDLE hFile = CreateFile(
        L"C:\\Users\\yam_l\\Desktop\\text.txt",
    ...
    // 从文件打开
    if (BuildIoRingReadFile(ioRing, IoRingHandleRefFromHandle(handles[0]), IoRingBufferRefFromPointer(buffer_info[0].Address), dwFileSize, 0, userDataRead, IOSQE_FLAGS_DRAIN_PRECEDING_OPS) == S_OK)
    {
